...
var Roulette = /** @class */ (function () {
    ...
    Roulette.prototype.getRandomInt = function (min, max) {
        return Math.floor(Math.random() * (max - min)) + min;
    };
    Roulette.prototype.listener = function () {
        var _this = this;
...
function startGame() {
    var container = document.querySelector(".container").querySelectorAll(".box");
    var myRoulette = new Roulette(container);
}
